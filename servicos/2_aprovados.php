...
<div class="container">
    ...
    <h1> Ordens de Serviço - Orçamentos aprovados Em Manutenção</h1><br><br>
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="_concluir_manutencao.php/?id=<?= $id_servico?>" class="btn btn-primary text-uppercase mb-3 botao">Concluir Manutenção</a>
                                </td>
                            </tr>
                            <?php
                        }
