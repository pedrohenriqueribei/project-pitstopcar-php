...
<div class="container">
    ...
    include_once "form-pesquisa.php";
    ?>

    <h1>Finalizados</h1><br><br>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                    ...
                    // A DATA DA FINALIZAÇÃO MENOR QUE A DATA DE HOJE PERDE A GARANTIA
                    
                    $sql = "SELECT s.id_negocio, s.id_servico, placa, s.dt_servico, s.dt_previsao, s.tipo, s.status, s.total_pagar, 
                        ...
                        WHERE s.id_master = ".ID_MASTER." AND s.status >= 8
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td><?= $garantia ?> dias</td>
                                <td><?= date('d/m/Y', strtotime('+'.$garantia.' days', strtotime($dt_servico))) ?></td>
