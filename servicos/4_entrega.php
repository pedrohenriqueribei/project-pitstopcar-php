...
<div class="container">
    ...
    <h1> Ordens de Serviço - Prontos para Entrega</h1><br><br>
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="_entregar_equipamento.php/?id=<?= $id_servico?>" class="btn btn-primary text-uppercase mb-3 botao">Finalizar OS</a>
                                </td>
                            </tr>
                            <?php
                        }
