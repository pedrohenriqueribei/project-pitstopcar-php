...
<div class="container">
    ...
    <h1> Automóveis Prontos </h1>
    <h2 style="text-align: center">Aguardando Pagamento</h2><br><br>
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                    $sql = "SELECT s.id_servico, s.id_negocio, placa, s.dt_servico, s.dt_previsao, s.tipo, s.status, s.total_pagar, c.nome, c.telefone
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="_conf_pagamento.php/?id=<?= $id_servico?>" class="btn btn-primary text-uppercase mb-3 botao">Confirmar Pagamento</a>
                                </td>
                            </tr>
                            <?php
                        }
